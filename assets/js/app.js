...
import { hooks as colocatedHooks } from "phoenix-colocated/bidding";
import topbar from "../vendor/topbar";

const socket = new Socket("/test_socket", {});
socket.connect();

// Test: Joining a channel
const test_channel = socket.channel("test:entry", {});
test_channel
  .join()
  .receive("ok", (resp) => {
    console.log("Tested joining successfully", resp);
  })
  .receive("error", (resp) => {
...
// Console log
console.log("tested send ping");

// Example; send a test message
test_channel
  .push("test_ping", { testing: "1 2 3" })
  .receive("ok", (resp) => console.log("Got reply:", resp));

// Receiving Messages with the JS Client
//
